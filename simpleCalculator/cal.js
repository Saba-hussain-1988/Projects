...
if (calcu.oprator === '+') {
    ...
    console.log(chalk.magenta(calcu.num1, calcu.oprator, calcu.num2, '=', Number(calcu.num1) + Number(calcu.num2)));
}
else if (calcu.oprator === '-') {
    // if user wanna substract 
    console.log(chalk.greenBright(calcu.num1, calcu.oprator, calcu.num2, '=', Number(calcu.num1) - Number(calcu.num2)));
}
else if (calcu.oprator === '*') {
    //if user want to multiply the values
    console.log(chalk.redBright(calcu.num1, calcu.oprator, calcu.num2, '=', Number(calcu.num1) * Number(calcu.num2)));
}
else if (calcu.oprator === '/') {
    //if user want to divide
    // then check the second Number should not be zero
    if (Number(calcu.num2) === 0) {
        ...
        console.log(chalk.cyanBright(calcu.num1, calcu.oprator, calcu.num2, '=', Number(calcu.num1) / Number(calcu.num2)));
    }
    ...
    if (Number(calcu.num2) === 0) {
        ...
        console.log(chalk.yellowBright(calcu.num1, calcu.oprator, calcu.num2, '=', Number(calcu.num1) % Number(calcu.num2)));
    }
    //if user choose exponant
}
else if (calcu.oprator === '**') {
    console.log(chalk.blueBright(calcu.num1, calcu.oprator, calcu.num2, '=', Number(calcu.num1) ** Number(calcu.num2)));
}
