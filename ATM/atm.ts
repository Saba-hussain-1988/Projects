...
let ans = await inquirer.prompt(
    {name: "pin", type : "number", message: chalk.rgb(252,117, 202)('enter your pin: ')}
)
...
if (ans.pin === myPin) {
    ...
    let operAns = await inquirer.prompt(
        {name: "operation", type: "list", message: chalk.rgb(245, 162, 60)('please select a operation'),
    ...
    if (operAns.operation === 'withdraw'){
        ...
        let amountAns = await inquirer.prompt(
            {name: "amount", type: "number", message: chalk.rgb(239, 245, 60)('enter your amount:')}
        )
        ...
        let accountNum = await inquirer.prompt(
            {name: "account", type: "input", message: chalk.rgb(250, 250, 300)('enter account number which you want to transfer money.')}
        )
        let amountAns = await inquirer.prompt(
            {name: "amount", type: "number", message: chalk.rgb(246, 135, 222)('enter your amount.')}
        )
        ...
        let amountAns = await inquirer.prompt(
            {name: "amount", type: "list", message: chalk.rgb(187, 103, 243)('select your amount.'),
